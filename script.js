$(document).ready(function() {
  ...
  function beautify() {
    ...
    var beautified_saturation_color_1 = primary_saturation - hue_distance_on_color_wheel(hsl_color_1[0], primary_hue);
    var beautified_saturation_color_2 = primary_saturation - hue_distance_on_color_wheel(hsl_color_2[0], primary_hue);
    var beautified_saturation_color_3 = primary_saturation - hue_distance_on_color_wheel(hsl_color_3[0], primary_hue);
    var beautified_saturation_color_4 = primary_saturation - hue_distance_on_color_wheel(hsl_color_4[0], primary_hue);
    var beautified_saturation_color_5 = primary_saturation - hue_distance_on_color_wheel(hsl_color_5[0], primary_hue);
